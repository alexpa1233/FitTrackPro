...
import ExerciseDatabase from '../../components/ExerciseDatabase'; // Asegúrate de la ruta
    ...
    try {
      ...
      if (response.data.code === 201) {
        ...
        setSelectedWorkout((prev) => ({
          ...prev,
          exercises: prev.exercises ? [...prev.exercises, newWorkoutExercise] : [newWorkoutExercise],
        }));
      } else {
  ...
  return (
    <div className="container-fluid bg-light">
      <div className="row">
        ...
        <div className={showExerciseDatabase ? "col-sm-9" : "col-sm-6"}>
          {showExerciseDatabase ? (
            <ExerciseDatabase
